...
whatis = whatis.append({'Command':'whatis -s "2" open','NL Queries':['Show section 2 of documentation of command open.',
																	'How do I see section 2 of man pages of what command open does?']},ignore_index=True)

whatis = whatis.append({'Command':'whatis -d ls','NL Queries':['Print debugging information of ls commands.',
																'How do I see debugging options of ls command?']},ignore_index=True)
...
whatis = whatis.append({'Command':'whatis -r ls','NL Queries':['Print all commands with 1 line descriptions which has ls in their names.',
															'How do I see 1 line Descriptions of all comands which have ls in their names?']},ignore_index=True)

whatis = whatis.append({'Command':'whatis -V','NL Queries':['Print the version of my whatis command.',
															'How do I see Version of my whatis command?']},ignore_index=True)
...
whatis = whatis.append({'Command':'whatis head tail','NL Queries':['How do I know what the commands head and tail does in one line?',
																'Get one line description of head & tail commands.',
																'How do I see what head & tail commands in linux do?']},ignore_index=True)
