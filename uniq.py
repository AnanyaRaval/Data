...
uniq = uniq.append({'Command':'uniq samplefile.txt','NL Queries':['Show samplefile.txt without consecutive duplicate lines.',
																...
																'Single command to filter unique lines from samplefile.txt',
																'Display all unique lines in the file samplefile.txt.',
																'Filter all unique lines from samplefile.txt.',
																'Command to check all distinct lines in samplefile.txt.']},ignore_index=True)
...
uniq = uniq.append({'Command':'uniq -d test','NL Queries':['Print only the lines that have multiple consecutive occurences in the file test.',
															'Display only repeated lines from the file test.',
															'How to filter out only repeated lines from the file test?',
															'Single command to see only repeated lines in the file test.',
															'Show only repeated lines from test.',
															'Display contents of test. Show lines, which have count more than 1, of file test.']},ignore_index=True)
...
uniq = uniq.append({'Command':'uniq -D samarth.txt','NL Queries':['Print only the lines that have multiple consecutive occurences in the file samarth.txt as many times as they occur in the file.',
																'Display only repeated lines from the file samarth.txt as many times as they repeat.',
...
uniq = uniq.append({'Command':'uniq -u instructions.txt','NL Queries':['Print only unique lines in the file instructions.txt on command line.',
...
uniq = uniq.append({'Command':'uniq -c -d myfile.txt','NL Queries':['Print only the lines that have multiple consecutive occurences in the file myfile.txt along with the number of occurences.',
																'Display only repeated lines from the file myfile.txt. Prefix each line with it\'s number of occurences.',
																'How to filter out only repeated lines from the file myfile.txt along with the number of times they repeat?',
																'Single command to see only repeated lines in the file myfile.txt and the number of repetitions.']},ignore_index=True)
...
uniq = uniq.append({'Command':'uniq -d -i sample.txt','NL Queries':['Print only the lines that have multiple consecutive occurences in the file sample.txt. Ignore case when comparing lines.',
																	'Ignore case when comparing lines and display only repeated lines from the file sample.txt',
																	'How to filter out only repeated lines from the file sample.txt while ignoring case during comparison?',
																	'Single command to see only repeated lines in the file sample.txt irrespective of case.']},ignore_index=True)
...
uniq = uniq.append({'Command':'uniq -d -w 10 tutorial.txt','NL Queries':['From tutorial.txt, only show lines that have multiple consecutive occurences. Consider only the first 10 characters of each line when comparing them.',
																		'Consider first 10 characters while comparing lines and display only repeated lines from the file tutorial.txt on the command line.',
																		...
																		'Single command to see only repeated lines from tutorial.txt while taking only first 10 characters into account when comparing lines.']},ignore_index=True)
...
uniq = uniq.append({'Command':'uniq -u -s 8 tutorial.txt','NL Queries':['From tutorial.txt, show only unique lines. Don\'t consider the first 8 characters of each line when comparing them.',
