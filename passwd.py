...
passwd = passwd.append({'Command':'sudo passwd -S -a','NL Queries':['Show password information of all user accounts, system-wide.',
											'How do I check password usability, last date of password change, minimum and maximum age password etc. for all users in the system?']},ignore_index=True)
...
passwd = passwd.append({'Command':'sudo passwd -l jane','NL Queries':['Lock account with username jane until system administrator unlocks it.',
												'How do I lock username jane?',
												'How do I stop access to the account jane so that she cannot log in?']},ignore_index=True)
...
passwd = passwd.append({'Command':'sudo passwd -e jane','NL Queries':['Expire password of username jane.',
											...
											'How can we expire the password of account jane?']},ignore_index=True)
...
passwd = passwd.append({'Command':'sudo passwd -d jane','NL Queries':['Delete password of jane\'s account.',
											...
											'How can we delete an account\'s password?']},ignore_index=True)

'''

passwd = passwd.append({'Command':'man passwd','NL Queries':['How do I know what the command passwd could do?','Get complete details of passwd command.','How do I see all options of passwd command in linux?']},ignore_index=True)
