...
chown = chown.append({'Command':'chown -v root:myname file.txt','NL Queries':['Change the user ownership of file.txt to root and group ownership to root. Display the owners for each file.',
...
chown = chown.append({'Command':'chown --from= root new1.txt','NL Queries':['How to change the ownership of file new1.txt to root?',
				'How do I change the ownership of the file new1.txt without to root knowing the current owner?',
...
chown = chown.append({'Command':'chown :mygroup demo.txt','NL Queries':['How do I change only the group ownership of the file demo.txt to myname?',
				...
				'How do I change the group ownership without changing the user ownership of the file demo.txt.']},ignore_index=True)
...
chown = chown.append({'Command':'chown --from=root andrew jokes.txt','NL Queries':['Change the ownership of jokes.txt to andrew only if the current owner is root.',
				'How do I change the owner of file jokes.txt to andrew only if current owner is root.',
					'How do I change ownership of jokes.txt to andrew only if I am sure the current owner is root?',
...
chown = chown.append({'Command':'chown --from=:group1 :group2 new.txt','NL Queries':['Change the group ownership of new.txt to group2 only if current group owner is group1',
			...
			'How do I change the group ownership of the file new.txt to group2 only if the current group ownership is known to be group1?']},ignore_index=True)
...
chown = chown.append({'Command':'chown --from=user1 :group1 file.txt','NL Queries':['Change the group ownership of file.txt to group1 only if current owner is user1.',
				'How do I change the group ownership of file.txt to group1 only if current user is user1?',
					'How do I change the group ownership of file.txt to group1 only when the current user is known to be user1?']},ignore_index=True)
...
chown = chown.append({'Command':'chown --from=:group1 user1 file.txt','NL Queries':['Change the ownership of file.txt to user1 if the group owner is group1.',
					...
					'How do I change the ownership of file file.txt to user1 only if the group owner group1 is known?']},ignore_index=True)
...
chown = chown.append({'Command':'chown -R -H guest:family linux_symlnk','NL Queries':['How do I forcefully change the owner/group ownership to guest/family of a symbolic link linux_symlnk recursively?',
