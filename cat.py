...
cat = cat.append({'Command':'cat -Ts instructions.txt',
				'NL Queries':['Display file instructions.txt with squeezing multiple adjacent empty lines and TAB character as ^I.',
							'How do I see the content of file instructions.txt with squeezing multiple adjacent empty lines and TAB character as ^I?',
...
cat = cat.append({'Command':'cat -Tu instructions.txt',
				'NL Queries':['Display file instructions.txt with output buffering disabled and TAB character as ^I.',
...
cat = cat.append({'Command':'cat -us instructions.txt',
				'NL Queries':['Display file instructions.txt with squeezing multiple adjacent blank lines and output buffering off.',
							'How do I see the content of file instructions.txt with squeezing multiple adjacent empty lines and output buffering off?',
							'Open file instructions.txt. Squeeze multiple adjacent empty lines. Set output buffering off.',
							'Show the content of instructions.txt with squeezing multiple adjacent blank lines and output buffering disabled.',
							'In the command line how do I see contents of file instructions.txt with squeezing multiple adjacent empty lines and output buffering cancelled.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -ns instructions.txt',
				'NL Queries':['Display file instructions.txt with squeezing multiple adjacent blank lines and numbering for each line.',
							'How do I see the content of file instructions.txt with squeezing multiple adjacent empty lines and numbering for each line?',
							'Open file instructions.txt. Squeeze multiple adjacent empty lines. Give numbering for each line.',
...
cat = cat.append({'Command':'cat -nes instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line.',
							'Open file instructions.txt. Display line numbers. Print non-printing characters. Squeeze multiple adjacent empty lines. $ at end of each line.',
							'How do i open a file instructions.txt with line numbers for each line, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line?',
							'Show the content of instructions.txt with line numbers, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -neT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, $ at end of each line and TAB character as ^I.',
							'Open file instructions.txt. Display line numbers. Print non-printing characters. Print TAB character as ^I. $ at end of each line.',
...
cat = cat.append({'Command':'cat -neu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, $ at end of each line and output buffering disabled.',
							'Open file instructions.txt. Display line numbers. Print non-printing characters. Set output buffering off. $ at end of each line.',
							...
							'Show the content of instructions.txt with line numbers, non-printing characters, output buffering off and $ at end of each line.',
...
cat = cat.append({'Command':'cat -nEs instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, squeeze multiple adjacent empty lines and $ at end of each line.',
							'Open file instructions.txt. Display line numbers. Squeeze multiple adjacent empty lines. $ at end of each line.',
							'How do i open a file instructions.txt with line numbers for each line, squeeze multiple adjacent empty lines and $ at end of each line?',
							'Show the content of instructions.txt with line numbers, squeeze multiple adjacent empty lines and $ at end of each line.',
...
cat = cat.append({'Command':'cat -nET instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, $ at end of each line and TAB character as ^I.',
							'Open file instructions.txt. Display line numbers. Print TAB character as ^I. $ at end of each line.',
...
cat = cat.append({'Command':'cat -nsT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, squeeze multiple adjacent empty lines and TAB character as ^I.',
							...
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, squeeze multiple adjacent empty lines and TAB character as ^I.']},ignore_index = True)

cat = cat.append({'Command':'cat -nst instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, squeeze multiple adjacent empty lines and TAB character as ^I.',
							...
							'How do i open a file instructions.txt with line numbers for each line, non-printing characters, squeeze multiple adjacent empty lines and TAB character as ^I?',
							...
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, non-printing characters, squeeze multiple adjacent empty lines and TAB character as ^I.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -nvu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters and output buffering disabled.',
							...
							'Show the content of instructions.txt with line numbers, non-printing characters and output buffering off.',
...
cat = cat.append({'Command':'cat -nut instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, TAB character as ^I and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for each line, non-printing characters, output buffering cancelled and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers, non-printing characters, output buffering off and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, non-printing characters, output buffering off and TAB character as ^I.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -nuT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, TAB character as ^I and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for each line, output buffering cancelled and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers, output buffering off and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, output buffering off and TAB character as ^I.']},ignore_index = True)

cat = cat.append({'Command':'cat -bes instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers only for non empty lines, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line.',
							'Open file instructions.txt. Display line numbers for non-blank lines. Print non-printing characters. Squeeze multiple adjacent empty lines. $ at end of each line.',
							'How do i open a file instructions.txt with line numbers for each non empty line, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line?',
							'Show the content of instructions.txt with line numbers only for non-blank lines, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non-blank line, non-printing characters, squeeze multiple adjacent empty lines and $ at end of each line.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -bEs instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, squeeze multiple adjacent empty lines and $ at end of each line.',
							'Open file instructions.txt. Display line numbers for non empty lines. Squeeze multiple adjacent empty lines. $ at end of each line.',
							'How do i open a file instructions.txt with line numbers for each non-blank line, squeeze multiple adjacent empty lines and $ at end of each line?',
							'Show the content of instructions.txt with line numbers for each non empty line, squeeze multiple adjacent empty lines and $ at end of each line.',
...
cat = cat.append({'Command':'cat -bsT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, squeeze multiple adjacent empty lines and TAB character as ^I.',
							...
							'How do i open a file instructions.txt with line numbers for each non empty line, squeeze multiple adjacent empty lines and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers for lines which are not blank, squeeze multiple adjacent empty lines and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line for lines which is not empty, squeeze multiple adjacent empty lines and TAB character as ^I.']},ignore_index = True)

cat = cat.append({'Command':'cat -bst instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for lines which are not empty, non-printing characters, squeeze multiple adjacent empty lines and TAB character as ^I.',
							...
							'How do i open a file instructions.txt with line numbers for each non empty line, non-printing characters, squeeze multiple adjacent empty lines and TAB character as ^I?',
...
cat = cat.append({'Command':'cat -bsu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non empty lines, squeeze multiple adjacent empty lines and output buffering disabled.',
							'Open file instructions.txt. Display line numbers for non-blank lines. Squeeze multiple adjacent empty lines. Set output buffering offed.',
							'How do i open a file instructions.txt with line numbers for each line non empty line, squeeze multiple adjacent empty lines and output buffering cancelled?',
...
cat = cat.append({'Command':'cat -bvu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, non-printing characters and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for each non-blank line, non-printing characters and output buffering cancelled?',
							'Show the content of instructions.txt with line numbers for each non-empty line, non-printing characters and output buffering off.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non empty or non-blank line, non-printing characters and output buffering off.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -but instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for lines which are non empty or non-blank, non-printing characters, TAB character as ^I and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for each non empty or non-blank line, non-printing characters, output buffering cancelled and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers for lines which are non empty or non-blank, non-printing characters, output buffering off and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non empty or non-blank line, non-printing characters, output buffering off and TAB character as ^I.']},ignore_index = True)

cat = cat.append({'Command':'cat -buT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for lines which are either non empty or non-blank, TAB character as ^I and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for each non empty or non-blank line, output buffering cancelled and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers for lines which are either non empty or non-blank, output buffering off and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non empty or non-blank line, output buffering off and TAB character as ^I.']},ignore_index = True)



cat = cat.append({'Command':'cat -nesT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.',
							...
							'How do i open a file instructions.txt with line numbers, $ at end of each line, non-printing characters, squeeze adjacent multiple empty lines and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers each line, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.']},ignore_index = True)

cat = cat.append({'Command':'cat -nesu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers, $ at end of each line, non-printing characters, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each line, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and output buffering cancelled.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)

cat = cat.append({'Command':'cat -nEsT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.',
							...
							'How do i open a file instructions.txt with line numbers, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers each line, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.']},ignore_index = True)

cat = cat.append({'Command':'cat -nEsu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers, $ at end of each line, squeeze adjacent multiple empty lines and output buffering disabled.',
							'Open file instructions.txt. Display line numbers. Add $ at end of each line. Squeeze adjacent multiple empty lines. Set output buffering disabled.',
							'How do i open a file instructions.txt with line numbers, $ at end of each line, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each line, $ at end of each line, squeeze adjacent multiple empty lines and output buffering cancelled.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line, $ at end of each line, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -besT instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.',
							...
							'How do i open a file instructions.txt with line numbers for non empty lines, $ at end of each line, non-printing characters, squeeze adjacent multiple empty lines and TAB character as ^I?',
							'Show the content of instructions.txt with line numbers for each non empty line, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non-blank line, non-printing characters, $ at end of each line, squeeze adjacent multiple empty lines and TAB character as ^I.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -nEsu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non empty lines, $ at end of each line, squeeze adjacent multiple empty lines and output buffering disabled.',
							'Open file instructions.txt. Display line numbers for non-blank lines. Add $ at end of each line. Squeeze adjacent multiple empty lines. Set output buffering disabled.',
							'How do i open a file instructions.txt with line numbers for non empty lines, $ at end of each line, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each line which is not blank, $ at end of each line, squeeze adjacent multiple empty lines and output buffering cancelled.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non-blank line, $ at end of each line, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)

cat = cat.append({'Command':'cat -bsvu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non empty lines, non-printing characters, squeeze adjacent multiple empty lines and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for non empty lines, non-printing characters, squeeze adjacent multiple empty lines and output buffering off?',
							...
							'In the command line how do I see contents of file instructions.txt with line numbers for each non empty line, non-printing characters, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)

cat = cat.append({'Command':'cat -bsTu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering disabled.',
							...
							'How do i open a file instructions.txt with line numbers for non-blank lines, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each non-blank line, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering cancelled.',
...
cat = cat.append({'Command':'cat -bstu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for lines which are neither empty not blank, non-printing characters, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering disabled.',
							'Open file instructions.txt. Display line numbers for lines which are neither empty not blank. Print TAB character as ^I. Print non-printing characters. Squeeze adjacent multiple empty lines. Set output buffering disabled.',
							'How do i open a file instructions.txt with line numbers for lines which are neither empty not blank, TAB character as ^I, non-printing characters, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each line which is neither empty nor blank, non-printing characters, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering cancelled.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each line which is neither empty nor blank, non-printing characters, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -bETsu instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, $ at end of each line, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering disabled.'
							'Open file instructions.txt. Display line numbers for lines which are neither empty not blank. Add $ at end of each line. Print TAB character as ^I. Squeeze adjacent multiple empty lines. Set output buffering disabled.',
							'How do i open a file instructions.txt with line numbers for non-blank lines, $ at end of each line, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each non-blank line, $ at end of each line, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering cancelled.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non-blank line, $ at end of each line, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)
...
cat = cat.append({'Command':'cat -bETsuv instructions.txt',
				'NL Queries':['Display file instructions.txt with line numbers for non-blank lines, $ at end of each line, TAB character as ^I, non-printing characters, squeeze adjacent multiple empty lines and output buffering disabled.'
							...
							'How do i open a file instructions.txt with line numbers for non-blank lines, $ at end of each line, TAB character as ^I, non-printing characters, squeeze adjacent multiple empty lines and output buffering off?',
							'Show the content of instructions.txt with line numbers each non-blank line, $ at end of each line, TAB character as ^I, non-printing characters, squeeze adjacent multiple empty lines and output buffering cancelled.',
							'In the command line how do I see contents of file instructions.txt with line numbers for each non-blank line, $ at end of each line, non-printing characters, TAB character as ^I, squeeze adjacent multiple empty lines and output buffering off.']},ignore_index = True)
