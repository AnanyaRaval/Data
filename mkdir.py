...
mkdir = mkdir.append({'Command': 'mkdir -m a=rwx mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that all users may read, write and execute the contents.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that all users can read, execute and write to it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 755 mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that owner can read, write and execute the contents but all others can only read and execute.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that owner can read, execute and write to it but all others can only read and execute it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it but all others can only read and execute it?'
								'Create folder mydir in this directory. I want all persmissions, read,write and execute. Any group and others should have only read and execute permissions.']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 700 mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that only owner can read, write and execute the contents.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that only owner can read, execute and write to it but all others have no rights on it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that only owner can read, execute and write to it but all others have no rights on it?',
								'Create folder named mydir in this directory. I want permissions of read write execute. Any group or any other should not have permission to read,write and execute.']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 711 mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that owner can read, write and execute the contents but all others can only execute.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that owner can read, execute and write to it but all others can only execute it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it but all others can only execute it?',
								'Create folder mydir in this directory. I should have all permissions, read,write and execute. Any group can execute. Any other can also execute.']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 766 mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that owner can read, write and execute the contents but all others can only read and write.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that owner can read, execute and write to it but all others can only read and write it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it but all others can only read and write it?',
								'Make folder mydir in this folder. Any group can read and write to it. Any other can also read and write to it. I should be able to read,write or execute.']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 744 mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that owner can read, write and execute the contents but all others can only read it.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that owner can read, execute and write to it but all others can only read it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it but all others can only read it?',
...
mkdir = mkdir.append({'Command': 'mkdir -m 722 mydir',
					'NL Queries':['Create the mydir directory and set its permissions such that owner can read, write and execute the contents but all others can only write it.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that owner can read, execute and write to it but all others can only write it?',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it but all others can only write it?'],
								'Make folder mydir. I want permission to read,write and execute. Any group or other users should only have permission to write to it.'},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 777 -v mydir',
					'NL Queries':['Create the mydir directory with a log and set its permissions such that all users may read, write and execute the contents.',
								...
								'How do I create a directory called mydir with a log and set it\'s persmissions so that all users can read, execute and write to it?',
								...
								'How do I create a folder called mydir with a log and set it\'s persmissions so that all users can read, execute and write to it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 755 -v mydir',
					'NL Queries':['Create the mydir directory with a log and set its permissions such that owner can read, write and execute the contents but all others can only read and execute.',
								...
								'How do I create a directory called mydir with a log and set it\'s persmissions so that owner can read, execute and write to it but all others can only read and execute it?',
								...
								'How do I create a folder called mydir with a log and set it\'s persmissions so that all users can read, execute and write to it but all others can only read and execute it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 777 -p myfolder/main/ananya',
					'NL Queries':['Create the ananya directory and set its permissions such that all users may read, write and execute the contents. Create parent directories(myfolder/main) if not present.',
								...
								'How do I create a directory called ananya, it\'s parent directories(myfolder/main) if not present and set it\'s persmissions so that all users can read, execute and write to it?',
								...
								'How do I create a folder called ananya, it\'s parent directories namely myfolder and main, if not present and set it\'s persmissions so that all users can read, execute and write to it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 700 -p myfolder/main/ananya',
					'NL Queries':['Create the ananya directory and set its permissions such that only owner can read, write and execute the contents. Create parent directories(myfolder/main) if not present.',
								...
								'How do I create a directory called ananya and it\'s parent directories(myfolder/main). Set it\'s persmissions so that only owner can read, execute and write to it but all others have no rights on it?',
								...
								'How do I create a folder called ananya and it\'s parent folders(myfolder/main). Set it\'s persmissions so that only owner can read, execute and write to it but all others have no rights on it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 711 -vp myfolder/main/ananya',
					'NL Queries':['Create the ananya directory and set its permissions such that owner can read, write and execute the contents but all others can only execute. Create parent directories(myfolder/main) if absent.',
								...
								'How do I create a directory called ananya with it\'s parent directories(myfolder/main) and set it\'s persmissions so that owner can read, execute and write to it but all others can only execute it?',
								...
								'How do I create a folder called ananya with it\'s parent folders(myfolder/main) and set it\'s persmissions so that all users can read, execute and write to it but all others can only execute it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 777 -Z mydir',
					'NL Queries':['Create the mydir directory, set its permissions such that all users may read, write and execute the contents and it\'s security context as default.',
								...
								'How do I create a directory called mydir and set it\'s persmissions so that all users can read, execute and write to it? Set security context to default type.',
								...
								'How do I create a folder called mydir and set it\'s persmissions so that all users can read, execute and write to it? Set security context to default type.']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 777 -vZ mydir',
					'NL Queries':['Create the mydir directory with a log and set its permissions such that all users may read, write and execute the contents. Set security context as default type. Show log of what is being created.',
								...
								'How do I create a directory called mydir with a log and security context as default type and set it\'s persmissions so that all users can read, execute and write to it?',
								...
								'How do I create a folder called mydir with a log and security context as default type and set it\'s persmissions so that all users can read, execute and write to it?']},ignore_index = True)
...
mkdir = mkdir.append({'Command': 'mkdir -m 777 -pZ myfolder/main/ananya',
					'NL Queries':['Create the ananya directory and set its permissions such that all users may read, write and execute the contents. Create parent directories(myfolder/main) if not present. Set security context as default type.',
								...
								'How do I create a directory called ananya, it\'s parent directories(myfolder/main) if not present and set it\'s persmissions so that all users can read, execute and write to it with security context set to default type?',
								...
								'How do I create a folder called ananya, it\'s parent folders namely myfolder and main, if not present and set it\'s persmissions so that all users can read, execute and write to it? Set security context as default type.']},ignore_index = True)
