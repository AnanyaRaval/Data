...
ifconfig = ifconfig.append({'Command':'ifconfig -a','NL Queries':['Show all interactive network interface details. Output should also include interfaces that are down.',
'How do I check link, hardware address, inetaddress, broadcast address etc. of all network interfaces?',
'Check the network hardware I have in my computer, even ones that are down.']},ignore_index=True)
...
ifconfig = ifconfig.append({'Command':'ifconfig -s eth0','NL Queries':['Give the status of the interface eth0 in short form.',
'Show the status of the interface eth0 in a short list.',
'How to see the status of eth0 in short form?',
'Single command to see details of the interface eth0 in a brief form.']},ignore_index=True)

ifconfig = ifconfig.append({'Command':'ifconfig -v eth0','NL Queries':['Give the status of the interface eth0 in verbose form.',
'Show the status of the interface eth0 in a verbose way.',
'How to see the verbose details of error conditions of eth0?',
'Single command to see details of any error conditions for the interface eth0 in a verbose form.']},ignore_index=True)

ifconfig = ifconfig.append({'Command':'ifconfig -a -s','NL Queries':['Show all interactive network interface details in a short list. Output should also include interfaces that are down.',
'How do I check link, hardware address, inetaddress, broadcast address etc. of all network interfaces? Output should be presented in a short list.',
'Check the network hardware I have in my computer, even ones that are down in the form of a short list.']},ignore_index=True)
