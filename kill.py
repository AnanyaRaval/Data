...
kill = kill.append({'Command':'kill -l','NL Queries':['List signal names for kill.',
...
kill = kill.append({'Command':'kill 123 543 2341 3453','NL Queries':['Kill all processes with ids 123 543 2341 3453.',
																	'Terminate all processes with kill 123 543 2341 3453.',
